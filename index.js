...
var context, gainNode, microphone;
...
if (window.mobilecheck()) {
    document.getElementById("init").addEventListener("touchend", toggleMonitoring);
} else {
    document.getElementById("init").addEventListener("click", toggleMonitoring);
}